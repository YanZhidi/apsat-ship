...
import com.zkthinke.repository.VerificationCodeRepository;
...
public class VerificationCodeServiceImpl implements VerificationCodeService {
    ...
    public EmailVo sendEmail(VerificationCode code) {
        ...
        if(verificationCode == null){
            ...
            emailVo = new EmailVo(Arrays.asList(code.getValue()),"智慧航运大数据平台",content);
        ...
        // 存在就再次发送原来的验证码
            ...
            emailVo = new EmailVo(Arrays.asList(verificationCode.getValue()),"智慧航运大数据平台",content);
        }
        return emailVo;
    }
