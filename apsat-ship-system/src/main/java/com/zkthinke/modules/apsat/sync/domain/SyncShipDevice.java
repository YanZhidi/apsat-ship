...
@Entity
@Data
@Table(name="t_sync_ship_device")
@ApiModel(value="t_sync_ship_device")
public class SyncShipDevice implements Serializable {
    ...
    public void copy(SyncShipDevice source){
